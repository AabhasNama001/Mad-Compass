...
const posts = [
  { title: "Mountain majesty", image: "/images/mountain.jpg" },
  { title: "Beachside bliss", image: "/images/beach.jpg" },
  { title: "Scenic panorama", image: "/images/view.jpg" },
];
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold sm:text-4xl">
              A glimpse of the landscapes and moments we love to shape into
              holidays.
            </h2>
          </div>
          <Link
