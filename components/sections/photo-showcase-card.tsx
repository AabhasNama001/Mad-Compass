...
export function PhotoShowcaseCard({ title, subtitle, description, badge, image, href }: PhotoShowcaseCardProps) {
  return (
    ...
    >
      <Link
        href={href}
        className="group block overflow-hidden rounded-4xl border border-[#ece7e4] bg-[#111111] text-white shadow-[0_24px_90px_rgba(17,17,17,0.16)] transition duration-300 hover:-translate-y-1"
